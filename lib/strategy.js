...
JwtStrategy.prototype.authenticate = function(req, options) {
    ...
    var useKey = this._secretOrKey;
    if(options && options.secretOrKey) {
        useKey = options.secretOrKey;
    }

    // Verify the JWT
    JwtStrategy.JwtVerifier(token, useKey, this._verifOpts, function(jwt_err, payload) {
        if (jwt_err) {
